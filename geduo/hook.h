/*
 * @Author: Choubin
 * @Date: 2020-06-26 00:06:33
 * @LastEditors: Choubin
 * @LastEditTime: 2020-06-26 00:07:50
 * @FilePath: /geduo/geduo/hook.h
 * @Description:  hook函数的封装
 */

#ifndef __GEDUO_HOOK_H__
#define __GEDUO_HOOK_H__
